...
Original file is located at
    https://colab.research.google.com/drive/1W9C5czAVuhtMe_Oq_O2xMsM7VtujkYv3
"""
...
for row in test_df['Text']:
    ...
    if max(one_x, two_x) == one_x:
        predictions.append(1)
    elif max(one_x, two_x) == two_x:
...
if onex > twox:
    classification = 'Class 1 (Mid)'
else:
    classification = 'Class 2 (Most)'
...
while running:
    ...
    # Get predictions for only onex and twox
    onex, twox = predict(S)

    # Classify based on onex and twox
    if onex > twox:
        classification = 'Class 1 (Mid)'
    else:
        classification = 'Class 2 (Most)'
